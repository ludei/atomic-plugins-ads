...
#pragma mark Utils
    ...
    - (void)layoutBanner: (LDAdBannerData *)data {
        ...
        switch (data.layout) {
            default:
            case LDBannerLayoutTopCenter:
                data.banner.view.center = CGPointMake(container.width * 0.5, size.height * 0.5);
                break;
            case LDBannerLayoutBottomCenter:
                data.banner.view.center = CGPointMake(container.width * 0.5, container.height - size.height * 0.5);
                break;
            case LDBannerLayoutCustom:
                data.banner.view.center = CGPointMake(data.customPosition.x + size.width * 0.5, data.customPosition.y + size.height * 0.5);
        }
    }
